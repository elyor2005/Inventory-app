                ...
                <div className="md:hidden p-4 space-y-4">
                  {ownedInventories.map((inventory) => (
                    <Link
                      ...
                      className="block bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-lg transition-shadow"
                    >
                      ...
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-gray-600 dark:text-gray-400">
                          {inventory._count.items} {t("items") || "items"}
                        </span>
